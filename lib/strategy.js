...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'https://api.channeladvisor.com/oauth2/authorize';
  options.tokenURL = options.tokenURL || 'https://api.channeladvisor.com/oauth2/token';
  options.scopeSeparator = options.scopeSeparator || ' ';
  options.accessType = options.accessType || 'offline';


  OAuth2Strategy.call(this, options, verify);
  this.name = 'channeladvisor';
  this._userProfileURL = options.userProfileURL || 'https://api.channeladvisor.com/oauth2/identity';
 ...
 * @api protected
 */
Strategy.prototype.userIdentity = function(accessToken, done) {
  this._oauth2.get(this._userProfileURL, accessToken, function (err, body, res) {
    ...
    profile.provider  = 'channeladvisor';
    profile._raw = body;
    profile._json = json;
    console.log(json);
    done(null, profile);
